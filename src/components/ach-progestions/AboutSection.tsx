...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section id="a-propos" className="py-20 bg-[#FAFAFC] scroll-mt-20">
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl border border-slate-100 bg-white">
                <div className="aspect-[16/10] sm:aspect-[4/3] relative w-full overflow-hidden bg-slate-900">
                  ...
                  />
                  <div className="absolute top-3 right-3 bg-white/95 backdrop-blur-md px-3 py-1.5 rounded-full text-[11px] text-slate-800 font-bold border border-white/60 shadow-md flex items-center gap-2">
                  ...
                  <div className="absolute bottom-3 left-3 bg-slate-900/85 backdrop-blur-md px-3.5 py-1.5 rounded-full text-[11px] text-white font-medium border border-white/10 flex items-center gap-2 shadow-sm">
                    <span className="w-2 h-2 rounded-full bg-[#FF6B00] animate-pulse" />
                    <span>Nos bureaux &amp; équipements dédiés</span>
                  </div>
                </div>
              </div>

              {/* Kitbitz Floating Office Accent */}
              <div className="absolute -bottom-6 -right-4 sm:-right-6 hidden sm:flex items-center gap-3 bg-white/95 backdrop-blur-md px-4 py-2.5 rounded-2xl shadow-xl border border-slate-200/80 z-20 hover:scale-105 transition-transform duration-300">
                <div className="w-10 h-10 rounded-xl bg-[#F7EEF4] flex items-center justify-center p-1.5 shrink-0 border border-[#5E1449]/10">
                  <Image
                ...
                <div>
                  <p className="text-[11px] font-bold text-slate-900">Poste de travail dédié</p>
                  <p className="text-[10px] text-slate-500">100% équipé &amp; sécurisé</p>
                </div>
              </div>
