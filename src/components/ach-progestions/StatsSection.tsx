...
export const StatsSection: React.FC = () => {
  ...
  return (
    <section className="py-14 bg-[#FAFAFC] border-y border-slate-100/80">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat) => {
            ...
            return (
              <div
                key={stat.label}
                className={`bg-white rounded-3xl p-7 border border-slate-100 transition-all duration-300 flex flex-col items-center text-center hover:-translate-y-1 ${
                  isOrange
              ...
              >
                ...
                <p className={`text-3xl sm:text-4xl font-black tracking-tight tabular-nums ${stat.valueColor}`}>
                  {stat.value}
                </p>
